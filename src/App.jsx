...
export default function App() {
  ...
  function loadProducts() {
    fetch("https://product-crud-backend-r6lv.onrender.com/products")
  ...
  function handleEditSubmit(event, id) {
    ...
    fetch(`https://product-crud-backend-r6lv.onrender.com/products/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  function handleDelete(id) {
    ...
    fetch(`https://product-crud-backend-r6lv.onrender.com/products/${id}`, { method: "DELETE" })
      .then(() => loadProducts())
